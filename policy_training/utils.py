...
# DATA_DIR = "/home/robot-lab/raunaq/holobot/extracted_data/venky_data/"
# DATA_DIR = "/home/raunaq/code/crossmodal_repr/data"
DATA_DIR = "/mnt/robotlab/siddhant/tactile_openteach/Open-Teach/data"
SAVE_PKL_DIR = "/mnt/robotlab/siddhant/tactile_openteach"


def history_key_map(key):
    if key.startswith("pixels"):
        return "pixels"
    elif key in ["cartesian_states", "gripper_states", "proprioceptive"]:
